...
public class ConsoleView implements View {
    ...
    @Override
    public int getValidNumberPropertyCancellable(String propertyName) {
        while (true) {
            String property = getProperty(propertyName);
    ...
    @Override
    public void showMessage(List messages) {
    ...
    @Override
    public Class<? extends Entity> getValidEntityClass(String type) {
        showMessage("Please provide a entity class");

        while (true) {
            String property = getProperty(type);
            try {
                Class<?> aClass = Class.forName("com.dq.trucks.model.entities."+property);
